...
| result.recorder | object | The recorder state. |
| result.recorder.initialised | boolean | True if the recorder is initialised. |
| result.recorder.errorMessage | string | The recorder error message, if any. |
| result.recorder.enabled | boolean | True if the recorder is enabled. |
| result.recorder.recordingDirectory | string | The recorder recording directory. |
...
| Name | Type | Description |
| --- | --- | --- |
| result | string | Always "acknowledged".   To check if the directory was changed, call `jamulusserver/getServerStatus` again. |
...
| Name | Type | Description |
| --- | --- | --- |
| result | string | Always "acknowledged".   To check if the recording was enabled, call `jamulusserver/getServerStatus` again. |
...
| Name | Type | Description |
| --- | --- | --- |
| result | string | Always "acknowledged".   To check if the recording was disabled, call `jamulusserver/getServerStatus` again. |
